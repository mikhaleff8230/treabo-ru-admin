...
export interface OtpLoginInput {
  ...
  name?: string;
  email?: string;
  permission?: string; // Для регистрации seller: 'store_owner'
}
...
export interface SetPinCodeInput {
  pin_code: string;
}
...
export interface Product {
  ...
  ratings: number;
  shop?: Shop;
  /** Текстовый адрес для карты / выдачи */
  address?: string;
  region_id?: string | number;
  geo_point?: { id?: string | number; lat?: number; lng?: number };
  geoPoint?: { id?: string | number; lat?: number; lng?: number };
  region?: { id?: string | number; name?: string; slug?: string };
}
...
export interface UpdateProductGroup extends Partial<CreateProductGroup> {
  id: string;
}
...
export interface UpdateProductSku extends Partial<CreateProductSku> {
  id: string;
}

export interface GenerateSkusInput {
  group_id: string;
  attribute_ids: string[];
  base_price?: number;
}

export interface ProductGroupQueryOptions extends QueryOptions {
  name?: string;
  shop_id?: string;
  category_id?: string;
  type_id?: string;
...
export interface ProductSkuQueryOptions extends QueryOptions {
  group_id?: string;
  is_active?: string;
}

export interface ProductGroupPaginator extends PaginatorInfo<ProductGroup> { }
export interface ProductSkuPaginator extends PaginatorInfo<ProductSku> { }

// ==================== End ProductGroup & ProductSku Types ====================
