...
export default function Orders() {
  ...
  // Добавляем логирование в консоль для отладки (можно убрать после исправления)
  if (typeof window !== 'undefined' && shopId) {
    console.log('[Orders Page] Запрос заказов для продавца:', {
      shopId,
      shopSlug: shop,
      params: orderQueryParams,
      shopData: shopData ? { id: shopData.id, slug: shopData.slug } : null,
    });
  }
