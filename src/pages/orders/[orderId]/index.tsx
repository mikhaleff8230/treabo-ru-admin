      ...
      <Card className="relative overflow-hidden">
        ...
        <div className="mt-12">
          ...
          {order?.shipping_address && (
            <>
              <p>Имя: {order.shipping_address.name}</p>
              <p>Телефон: {order.shipping_address.phone}</p>
              <p>Адрес: {order.shipping_address.address}</p>
              <p>Комментарий: {order.shipping_address.comment}</p>
              <div className="mt-4 flex items-center gap-2">
                ...
                />
                <Button
                  onClick={() => updateOrder({ id: order.id, tracking_number: trackingNumber })}
                  loading={updating}
                >
