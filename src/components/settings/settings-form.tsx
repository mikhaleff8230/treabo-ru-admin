      ...
      <div className="my-5 flex flex-wrap border-b border-dashed border-border-base pb-8 sm:my-8">
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          ...
          <p className="text-sm text-gray-500 mb-5">
            Установите 0 для отключения отображения копеек, 1-5 для указания количества знаков после запятой
          </p>
          {formation && (
            <div className="mb-5">
              <Label>
              ...
              {currentFractions === 0 && (
                <p className="text-xs text-gray-400 mt-1">
                  Копейки отключены - цены будут отображаться без дробной части
                </p>
              )}
            </div>
          )}
